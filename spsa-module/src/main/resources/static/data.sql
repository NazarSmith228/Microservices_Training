...
INSERT INTO article_comment(content, creation_date, image, user_id, article_id)
VALUES ('( ͡°( ͡° ͜ʖ( ͡° ͜ʖ ͡°)ʖ ͡°) ͡°)', parsedatetime('2020-21-03|18:25:59:1', 'YYYY-MM-DD|hh:mm:ss'), null, 2,
        1);

INSERT INTO event(date_meeting, time_meeting, description, location_id, owner_id)
VALUES ('2020-04-23', '18:05:00', 'Sport event', 1, 2),
       ('2020-04-23', '18:20:00', 'Go to gym', 3, 1);
...
VALUES (1, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-04', 'yyyy-MM-dd')),
       (1, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-05', 'yyyy-MM-dd')),
       (2, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-04', 'yyyy-MM-dd')),
       (2, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-05', 'yyyy-MM-dd')),
       (3, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-04', 'yyyy-MM-dd')),
       (3, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-05', 'yyyy-MM-dd')),
       (4, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-04', 'yyyy-MM-dd')),
       (4, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-05', 'yyyy-MM-dd')),
       (5, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-04', 'yyyy-MM-dd')),
       (5, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-05', 'yyyy-MM-dd')),
       (6, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-04', 'yyyy-MM-dd')),
       (6, 2, 15, 7200000000000, 1, 1, parsedatetime('2020-04-05', 'yyyy-MM-dd'));
