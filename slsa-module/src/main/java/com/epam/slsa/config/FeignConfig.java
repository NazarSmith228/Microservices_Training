...
public class FeignConfig {
    ...
    @Bean
    public Client feignClient() throws KeyManagementException, NoSuchAlgorithmException {
        return new Client.Default(
                new NaiveSSLSocketFactory("localhost"),
                new NaiveHostnameVerifier("localhost"));
    }

    public static class NaiveHostnameVerifier implements HostnameVerifier {
